...
public enum ErrorCode {
    ...
    DUPLICATE_PREVIEW_EXCEPTION(RestAPIStatus.EXISTED,-309 ,"A preview with this challenge ID and label already exists.","Existed","Preview với challenge ID và label đã tồn tại"),
